...
const Services = () => {
  ...
  return (
    <section className="services-section my-md-5">
      ...
      <div className="text-center my-5 py-md-5 section-header">
      ...
      <div className="services-container d-flex justify-content-center gap-md-5 gap-3 flex-wrap w-75 mx-auto px-sm-0 px-4 mb-md-0 mb-5">
